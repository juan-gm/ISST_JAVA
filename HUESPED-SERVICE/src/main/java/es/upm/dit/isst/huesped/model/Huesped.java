...
import es.upm.dit.isst.huesped.model.Solicitudes;
...
public class Huesped implements Serializable {
    ...
    private ArrayList<Solicitudes> list = new ArrayList<Solicitudes>();
	...
	public String toString() {
		return "Huesped [email=" + email + ", password=" + password + ", name=" + name + ", surname=" + surname
				+ ", dni=" + dni + ", toPayAccount=" + 
				toPayAccount + 
				", roomNumber=" + roomNumber + ", creditCard="
				+ creditCard + ", telephoneNumber=" + telephoneNumber + "]";
	}

	public Huesped(
//			String email, String password, String name, String surname, int dni, int roomNumber,
//			int creditCard, int telephoneNumber, List list
			) {
//		this.email = email;
//		this.password = password;
//		this.name = name;
