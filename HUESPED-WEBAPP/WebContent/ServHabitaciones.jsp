...
<body>
 ...
 <br>
 <h2>Aqui puedes consultar las diferentes solicitudes a realizar que llevaremos directamente a tu habitación.</h2>
 <br>
...
<h4>Escriba aquí sus comentarios sobre el pedido.</h4>

<textarea id="Solicitud" rows="10" cols="80" placeholder="Escriba aquí sus comentarios sobre el pedido." 
