...
@WebServlet("/FormGestiondePerfil")
public class FormGestiondePerfil extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/GestiondePerfil.jsp").forward(req,resp);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
	  ...
	  getServletContext().getRequestDispatcher("/GestiondePerfil.jsp").forward(request,response);
	}
